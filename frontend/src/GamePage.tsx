          ...
          <div className="TrophyList">
            ...
            {game.trophy.map(trophy => (
              <div key={trophy.trophy_name} className="TrophyListItem TrophyListRow">
                <div className="TrophyListColumn TrophyListStatus"><img alt={`${trophy.achieved === "1"? "Achieved": "Not Achieved"}`} src={`${webAPIUrl}/trophy/image/show?game=${game.shortname}&trophy=${trophy.trophy_name}&achieved=${trophy.achieved}`} /></div>
